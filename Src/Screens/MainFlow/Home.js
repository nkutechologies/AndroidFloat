        ...
        <Header   title="Dashboard" backIcon={true} backIconPress={()=>backPress()} />
            <ImageBackground source={Images.homebg} style={styles.bgimageStyle}>
             <View style={{marginTop:Theme.screenHeight/70}}>
                ...
                <View>
                    <Card elevation={10} style={styles.cardViewStyle}
                ...
                <View>
                    <Card elevation={10} style={styles.cardViewStyle}
                        ...
                        <View style={styles.cardFirstView}>
                            <Image source={Images.dummy} style={styles.imageStyle} />
                            <View style={styles.textViewStyle}>
                                <Text style={styles.nameTextStyle}>Consumer Interception</Text>
                            </View>
                            <Image source={Images.fwdArrow} style={styles.logo} />
                        </View>
                    </Card>
...
const styles = StyleSheet.create({
    ...
    cardViewStyle: {
        ...
        marginVertical: Theme.screenHeight /85, padding: Theme.screenHeight / 99
    },
