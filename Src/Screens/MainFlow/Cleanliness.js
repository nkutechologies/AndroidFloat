...
import { View, Text, StyleSheet, Image, TouchableOpacity, ImageBackground ,LogBox} from 'react-native';
                ...
                <View style={{ flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-evenly', marginTop: Theme.screenHeight / 20, }}>
                    {ProfileImage && ProfileImage != '' ?
                        <View>
                            ...
                            <ImageBackground source={{ uri: ProfileImage }} resizeMode="cover"
                                style={styles.bgimageStyle} >
                                <TouchableOpacity style={styles.crossViewStyle}>
                                    <AntDesign name="close" onPress={() => setProfileImage("")} size={Theme.screenHeight / 40} color={Theme.white} />
                                </TouchableOpacity>
                            </ImageBackground>
                        </View>
                        :
                    ...
                    {ProfileImage1 && ProfileImage1 != '' ?
                        <View>
                            ...
                            <ImageBackground source={{ uri: ProfileImage1 }} resizeMode="cover"
                                style={styles.bgimageStyle} >
                                <TouchableOpacity style={styles.crossViewStyle}>
                                    <AntDesign name="close" onPress={() => setProfileImage1("")} size={Theme.screenHeight / 40} color={Theme.white} />
                                </TouchableOpacity>
                            </ImageBackground>
                        </View>
                        :
                    ...
                    {ProfileImage2 && ProfileImage2 != '' ?
                        <View>
                            ...
                            <ImageBackground source={{ uri: ProfileImage2 }} resizeMode="cover"
                                style={styles.bgimageStyle}>
                                <TouchableOpacity style={styles.crossViewStyle}>
                                    <AntDesign name="close" onPress={() => setProfileImage2("")} size={Theme.screenHeight / 40} color={Theme.white} />
                                </TouchableOpacity>
                            </ImageBackground>
                        </View>
                        :
                    ...
                    {ProfileImage3 && ProfileImage3 != '' ?
                        <View>
                            ...
                            <ImageBackground source={{ uri: ProfileImage3 }} resizeMode="cover"
                                style={styles.bgimageStyle} >
                                <TouchableOpacity style={styles.crossViewStyle}>
                                    <AntDesign name="close" onPress={() => setProfileImage3("")} size={Theme.screenHeight / 40} color={Theme.white} />
                                </TouchableOpacity>
                            </ImageBackground>
                        </View>
                        :
...
const styles = StyleSheet.create({
    ...
    crossViewStyle: {
        alignSelf: 'flex-end',
        position: 'absolute', backgroundColor: Theme.black, borderRadius: 50,
        margin:5
    },
    bgimageStyle:
    {
        height: Theme.screenHeight / 6.5
        , width: Theme.screenHeight / 6.5, marginVertical: 15
    }
});
